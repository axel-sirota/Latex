\documentclass[oneside,english,spanish,12pt]{book}
...
\includegraphics[scale=.3]{./uba.jpg}
...
\centerline{\Large \bf UNIVERSIDAD DE BUENOS AIRES}
...
\centerline{\Large Departamento de Matem\'atica}


\vfill


\centerline{\bf \LARGE T\'itulo a definir}
...
\centerline{\Large Axel Sirota}


\vfill


{\Large Director de Tesis: Dr. Pablo Amster}


\bigskip


{\large  Lugar de Trabajo: Departamento de Matem\'atica- FCEyN (UBA)}


\bigskip


\centerline{Buenos Aires, Septiembre?? de 2018.}
