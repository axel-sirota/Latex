...
\begin{proof}
	...
	\begin{enumerate}
		...
		\marginpar{Usamos filtraciones y el teorema de convergencia de cuasi-martingalas}
...
\begin{proof}
	...
	\begin{enumerate}
		...
		\marginpar{Dado que hicimos lo mismo 3 veces, valdr\'ia que sea un lema?}
...
\begin{theorem}[Convergencia a puntos extremales algoritmo estoc\'astico insesgado]
	...
	\begin{enumerate}
		...
		\end{equation}
		 ...
		 \end{equation}
		 		 ...
		 		 \marginpar{Usamos el teorema de convergencia dominada en esperanza condicional}
